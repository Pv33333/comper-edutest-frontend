...
function ChartCanvas({ config, height = 240, width = 240, className = "" }) {
  ...
  return (
    <canvas ref={ref} height={height} width={width} className={className} />
  );
}
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white px-6 text-center">
          ...
          <p className="text-lg md:text-xl lg:text-2xl max-w-2xl mb-8 text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.55)]">
            Platforma inteligentă care oferă elevilor încredere, părinților
            vizibilitate și profesorilor control educațional.
          </p>
      ...
      <section className="bg-[#F9E588]/60 px-10 py-24 text-center">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-semibold text-blue-800 mb-6">
            Pentru fiecare rol educațional
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          >
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-in-out bg-white/90 text-gray-800 text-base leading-relaxed px-6 py-4 rounded-xl shadow z-30 w-80 text-center">
              Accesează teste interactive, primește feedback instant și
          ...
          >
            <img
              alt="Părinte"
              className="absolute inset-0 w-full h-full object-cover object-center z-0"
              src="/assets/realistic_parinte_cu_test_bifat.png"
            />
            <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition duration-300 z-10"></div>
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <h3 className="text-3xl font-bold text-white drop-shadow-xl tracking-wide">
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-in-out bg-white/90 text-gray-800 text-base leading-relaxed px-6 py-4 rounded-xl shadow z-30 w-80 text-center">
              Monitorizează evoluția copilului, vizualizează rapoarte detaliate
              și implică-te activ în parcursul său educațional.
            </div>
          </Link>
          ...
          >
            <img
              alt="Profesor"
              className="absolute inset-0 w-full h-full object-cover object-center z-0"
              src="/assets/realistic_profesor_final.png"
            />
            <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition duration-300 z-10"></div>
            <div className="absolute inset-0 z-20 flex items-center justify-center">
              <h3 className="text-3xl font-bold text-white drop-shadow-xl tracking-wide">
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 ease-in-out bg-white/90 text-gray-800 text-base leading-relaxed px-6 py-4 rounded-xl shadow z-30 w-80 text-center">
              Creează teste personalizate, analizează performanțele elevilor și
              oferă sprijin adaptat nevoilor fiecăruia.
            </div>
          </Link>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 max-w-7xl mx-auto">
          {[
            ...
            >
              ...
              />
              <span className="mt-3 text-sm text-blue-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 text-base mb-8">
              Analiză vizuală a testelor disponibile, finalizate și progres în
              timp
            </p>
          </div>
            ...
            {[
              {
                ...
                nume: "Adriana T.",
                rol: "părinte",
                text: "„În doar câteva teste, copilul meu a prins curaj.”",
              },
              {
                img: 12,
                nume: "Mihai R.",
                rol: "profesor",
                text: "„Platforma îmi permite să personalizez testarea pentru fiecare elev.”",
              },
              {
                img: 14,
                nume: "Ioana D.",
                rol: "elev",
                text: "„Testele sunt clare și ușor de înțeles. Mă simt mai încrezătoare acum.”",
              },
              {
                img: 15,
                nume: "Daniel P.",
                rol: "părinte",
                text: "„Rapoartele săptămânale mă ajută să rămân implicat.”",
              },
              {
                img: 18,
                nume: "Corina M.",
                rol: "profesor",
                text: "„Excelent pentru predare diferențiată.”",
              },
              {
                img: 20,
                nume: "Alex V.",
                rol: "elev",
                text: "„E ca un joc — învăț fără să simt presiune.”",
              },
              {
                img: 23,
                nume: "Ruxandra L.",
                rol: "părinte",
                text: "„Comunicarea cu profesorii prin platformă e foarte eficientă.”",
              },
              {
                img: 24,
                nume: "George N.",
                rol: "profesor",
                text: "„Evaluările automate îmi economisesc timp prețios.”",
              },
              {
                img: 26,
                nume: "Bianca F.",
                rol: "elev",
                text: "„Am luat primul meu 10 datorită testelor Comper!”",
              },
              {
                img: 28,
                nume: "Tudor S.",
                rol: "părinte",
                text: "„Vă mulțumesc! Copilul meu e din nou motivat.”",
              },
            ].map((r, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`min-w-full px-4 ${hidden ? "hidden" : ""}`}
                >
      ...
      {!cookieOk && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[90%] max-w-3xl bg-gradient-to-r from-white to-blue-50 border border-gray-200 shadow-xl rounded-2xl p-6 z-50 text-center text-gray-800">
          ...
          <p className="text-gray-700 text-base mb-8">
            Folosim cookie-uri esențiale și tehnologii similare pentru a asigura
            funcționalitatea optimă a platformei, pentru analize statistice și
            pentru personalizarea experienței tale. Prin continuarea navigării
            sau apăsarea pe „Accept”, îți exprimi acordul pentru utilizarea
            acestora conform{" "}
            <a
