...
export default function RaportMate10() {
  ...
  const pdfHtml = useMemo(() => {
    return localStorage.getItem("pdf_mate_10") || "";
  }, []);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-2xl font-bold text-green-700 mb-4">📄 Raport – Matematică (Clasa a IV-a)</h1>
      ...
      {pdfHtml ? (
        ...
        <div className="bg-gray-50 border border-gray-200 text-gray-700 rounded-xl p-4">
          Nu există conținut salvat pentru raport (pdf_mate_10). Generează raportul din test.
        </div>
      )}
    </div>
  );
