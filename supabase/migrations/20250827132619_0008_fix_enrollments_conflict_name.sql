-- 0008_fix_enrollments_conflict_name.sql
-- Fix: folosește numele corect al constrângerii unice în ON CONFLICT
...
begin
  ...
  on conflict on constraint enrollments_class_id_student_id_key do nothing;

  -- returnează perechea (idempotent: dacă exista deja, tot o returnăm)
  return query
